...
## Project Structure
    ...
    ├── siqi_zhou_mellow_ba_37015  # Django project configurations
...
1. Clone this repo and `cd siqi_zhou_mellow_ba_37015`
...
2. Clone this repo and `cd siqi_zhou_mellow_ba_37015`
